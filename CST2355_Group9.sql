...
INSERT INTO customer_telephone VALUES (1, '2024-11-01 08:00:00', NULL, 1, 1); 
INSERT INTO customer_telephone VALUES (2, '2024-11-15 10:30:00', '2024-11-30 12:00:00', 2, 2); 
INSERT INTO customer_telephone VALUES (3, '2024-11-20 14:00:00', NULL, 3, 3);
...
INSERT INTO equipment_name VALUES (1, TO_TIMESTAMP('2024-11-01 08:00:00', 'YYYY-MM-DD HH24:MI:SS'), NULL, 1, 1); 
INSERT INTO equipment_name VALUES (2, TO_TIMESTAMP('2024-11-02 09:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-11-05 17:00:00', 'YYYY-MM-DD HH24:MI:SS'), 2, 2); 
INSERT INTO equipment_name VALUES (3, TO_TIMESTAMP('2024-11-03 10:00:00', 'YYYY-MM-DD HH24:MI:SS'), NULL, 3, 3);
...
SELECT * FROM address WHERE idtelephone = 1;
SELECT * FROM customer_telephone WHERE idcustomer_telephone = 1;
